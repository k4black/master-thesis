...
# sns.scatterplot(data=attention_data, x='Layer', y='Average Value (Relative)', hue='Type', ax=axes[0], alpha=0.5, legend=False)
...
# sns.scatterplot(data=ffn_neurons_data, x='Layer', y='Average Value (Relative)', hue='Type', ax=axes[1], alpha=0.5, legend=False)
